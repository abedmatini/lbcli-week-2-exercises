...
TXID=$(bitcoin-cli decoderawtransaction "$raw_tx" | jq -r '.txid')

bitcoin-cli createrawtransaction "[{\"txid\":\"$TXID\",\"vout\":0},{\"txid\":\"$TXID\",\"vout\":1}]" "{\"2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP\":0.23659108}"
